//
//  MusicFavouriteListDetailView.swift
//  iTunes Client App
//
...
final class MusicFavouriteListDetailView: UIView {
    ...
    var collectionName: String? {
        didSet {
            longDescriptionKeyLabel.text = "Collection Name:"
            longDescriptionKeyLabel.font = .boldSystemFont(ofSize: 17.0)
            longDescriptionLabel.text = collectionName ?? "-"
        }
    }
